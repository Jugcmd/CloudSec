# CloudSec — Threat Model (STRIDE)

This document records the threat model for the CloudSec application, produced using the
STRIDE methodology (Shostack, 2014). STRIDE is a structured approach to identifying
security threats across six categories. It was originally developed at Microsoft and
remains a standard tool for cloud application security design.
...
- Microsoft (2023) *Azure Security Benchmark*. Available at: https://learn.microsoft.com/en-us/security/benchmark/azure/
